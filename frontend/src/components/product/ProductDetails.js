...
const ProductDetails = ({ match }) => {
  ...
  useEffect(() => {
    ...
    if (success) {
      alert.success('Reivew publicada con éxito')
        ...
        <Fragment>
          ...
          <div className="row d-flex justify-content-around">
            ...
            <div className="col-12 col-lg-5 mt-5">
              ...
              <p id="product_price">${product.price} MXN</p>
              ...
              <p>Status: <span id="stock_status" className={product.stock > 0 ? 'greenColor' : 'redColor'} >{product.stock > 0 ? 'En Stock' : 'Fuera de Stock'}</span></p>

              <hr />

              <h4 className="mt-2">Descripción del producto:</h4>
              ...
              {user ? <button id="review_btn" type="button" className="btn btn-primary mt-4" data-toggle="modal" data-target="#ratingModal" onClick={setUserRatings}>
                ...
                :
                <div className="alert alert-danger mt-5" type='alert'>Inicia sesión para publicar una review</div>
              }
                    ...
                    <div className="modal-dialog" role="document">
                      <div className="modal-content">
                        <div className="modal-header">
                          <h5 className="modal-title" id="ratingModalLabel">Publicar Review</h5>
